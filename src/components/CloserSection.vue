<template>
  <div class="p-8 max-w-prose m-auto my-8 rounded-3xl bg-dark">
    <h3 class="text-2xl mb-4">Visit Us Today</h3>
    <p>
      Discover the Dry Clean Super Center difference. Visit one of our convenient locations, or take
